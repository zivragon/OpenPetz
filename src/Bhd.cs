...
//  GAME STRUCTS FOR PARSING PURPOSES
    ...
    internal unsafe struct BhdSerialized {                                  //  memory layout of an entire BHD file
    ...
    [StructLayout(LayoutKind.Explicit)]
    internal unsafe struct BdtFrameHeaderSerialized {                       //  memory layout of a BDT frame header
    ...
    internal unsafe struct BdtFrame {                                       //  memory layout of a BDT frame
        ...
        internal unsafe struct BdtBallSizeOverrideArray {                           //  memory layout of an array of ball size overrides
            ...
            [StructLayout(LayoutKind.Explicit)]
            internal unsafe struct BdtFrameBallSizeOverride {               //  memory layout of a single ball size override
    ...
    [StructLayout(LayoutKind.Explicit)]
    internal unsafe struct XTVector3_Int16 {        //  memory layout of a 3D vector
    ...
    [StructLayout(LayoutKind.Explicit)]
    internal unsafe struct XPointRot3_16 {                      //  memory layout of a 3D point with rotation
